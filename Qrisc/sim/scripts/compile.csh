...
setenv my_path /ensc/fac1/fcampi/Projects/Qrisc/vhdl/5.9
...
echo "Testbench"
vcom -quiet $my_path/TESTBENCH/SRAM.vhd
vcom -novopt -quiet $my_path/TESTBENCH/Debug_Tool.vhd
vcom -novopt -quiet $my_path/TESTBENCH/tb_qrisc_light.vhd
