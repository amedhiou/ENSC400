...
analyze -format vhdl ../vhdl/5.9/CORE/xi_menu.vhd
analyze -format vhdl ../vhdl/5.9/CORE/xi_basic.vhd

echo "------------------------ XiRisc Core"   
echo ""
echo "- Miscellaneous"
analyze -format vhdl ../vhdl/5.9/CORE/xi_isa32.vhd
analyze -format vhdl ../vhdl/5.9/CORE/xi_components.vhd
analyze -format vhdl ../vhdl/5.9/CORE/xi_definitions.vhd
echo ""
echo "- Control Logic"
analyze -format vhdl ../vhdl/5.9/CORE/xi_decodeop32.vhd
analyze -format vhdl ../vhdl/5.9/CORE/xi_decodepc.vhd
analyze -format vhdl ../vhdl/5.9/CORE/xi_hazards.vhd
analyze -format vhdl ../vhdl/5.9/CORE/xi_pcbvgen.vhd
analyze -format vhdl ../vhdl/5.9/CORE/xi_addrcheck.vhd
analyze -format vhdl ../vhdl/5.9/CORE/xi_control.vhd
echo ""

echo "- Data Path"
analyze -format vhdl ../vhdl/5.9/CORE/xi_alu_simple.vhd
analyze -format vhdl ../vhdl/5.9/CORE/xi_shifter.vhd
analyze -format vhdl ../vhdl/5.9/CORE/xi_multiplier.vhd
analyze -format vhdl ../vhdl/5.9/CORE/xi_memhandle.vhd
analyze -format vhdl ../vhdl/5.9/CORE/xi_mainchannel.vhd
echo ""

echo "- Register File"
analyze -format vhdl ../vhdl/5.9/CORE/xi_rfile.vhd
echo ""

echo "- SCC Coprocessor"
analyze -format vhdl ../vhdl/5.9/CORE/xi_scc.vhd
echo ""

echo "- FPU Coprocessor"
analyze -format vhdl ../vhdl/5.9/CORE/xi_fpu.vhd
echo ""

echo "- DBG Coprocessor"
analyze -format vhdl ../vhdl/5.9/CORE/xi_dbg.vhd
echo ""

echo "- Breaks Verification System"
analyze -format vhdl ../vhdl/5.9/CORE/xi_verify.vhd
echo ""

echo "- XiRisc Core"
analyze -format vhdl ../vhdl/5.9/CORE/xi_core.vhd 
echo ""
...
create_clock -name CLK -period 6 -waveform {0 3}  {CLK}
