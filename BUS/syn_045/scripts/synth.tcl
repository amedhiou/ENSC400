...
set search_path   [ list /ensc/fac1/fcampi/SOCLAB/LIBRARIES/NangateOpenCellLibrary_PDKv1_3_v2010_12/Front_End/DB \
		    /ensc/grad1/cmc-16/ENSC400/BUS/syn_045 ]
...
analyze -format vhdl ../vhdl/BUS.vhd
analyze -format vhdl ../vhdl/Top_BUS.vhd
analyze -format vhdl ../vhdl/BUS_M_4S.vhd
analyze -format vhdl ../../REG/vhdl/REG.vhd
# Logic Synthesis
elaborate $TOP 
